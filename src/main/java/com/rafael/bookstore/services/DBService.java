...
public class DBService{
    ...
    public void instanciaBaseDeDados() {
		...
		Categoria cat2 = new Categoria(null, "Arquitetura", "Livros de Arq");
		...
		Livro l3 = new Livro(null, "Arquitetura", "Robert Maier", "lorem", cat2);
		Livro l4 = new Livro(null, "Engenharia Desco", "Jeff Boss", "Lorem ipsum", cat2);
